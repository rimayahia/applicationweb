...
<body>
  ...
  { ?>
                  <li>
                    <a data-toggle="tab" href="#overview"> La liste des ordonnances</a>
                  </li>
                  <li class="active">
                    <a data-toggle="tab" href="#edit">Modifier un ordonnance </a>
                  </li>
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                              <thead>
                                ...
                                <th><center>N°</center></th>
                                  <th><center>médicament 1</center></th>
                                  <th><center>médicament 2</center></th>
                                  <th><center>médicament 3</center></th>
                                  <th><center>médicament 4</center></th>
								                  <th><center>médicament 5</center></th>
                                  <th><center>médicament 6</center></th>
                                  <th><center>médicament 7</center></th>
                  ...
                  <div id="edit" class="tab-pane">
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-lg-offset-2 detailed">
                        <h4 class="mb">Nouveau ordonnance</h4>
                        <form role="form" class="form-horizontal"method="post" action="trtm/insctor.php" >
                          
                          <div class="form-group">
                            <label class="col-lg-2 control-label">médicament1</label>
                            <div class="col-lg-6">
                          ...
                          <div class="form-group">
                            <label class="col-lg-2 control-label">médicament2</label>
                            <div class="col-lg-6">
                          ...
                          <div class="form-group">
                            <label class="col-lg-2 control-label">médicament3</label>
                            <div class="col-lg-6">
                              <input type="text" placeholder=" " id="aa" name="aa" class="form-control">
						              ...
						              <div class="form-group">
                            <label class="col-lg-2 control-label">médicament4</label>
                            <div class="col-lg-6">
                              <input type="text" placeholder=" " id="na" name="na" class="form-control">
                            </div>
                          </div>
						             <div class="form-group">
                            <label class="col-lg-2 control-label">médicament5</label>
                            ...
                            <div class="col-lg-6">
                              <input type="text" placeholder=" " id="ml" name="ml" class="form-control">
						             ...
						             <div class="form-group">
                            <label class="col-lg-2 control-label">médicament6</label>
                         ...
                         <div class="form-group">
                            <label class="col-lg-2 control-label">médicament7</label>
