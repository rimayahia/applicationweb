...
<body>
        ...
        <p class="centered"><a href="compte.php"><img src="<?php echo $_SESSION['img'];?>" class="img-circle" width="80"></a></p>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="."active"."><a href="."facture.php".">factures</a></li> ";?>
  ...
  { ?>
                  <li>
                    <a data-toggle="tab" href="#overview">liste des factures</a>
                  </li>
                  <li class="active">
                    <a data-toggle="tab" href="#edit">Modifier une facture</a>
                  </li>
...
<li class="active">
                  ...
                  <li >
                    <a data-toggle="tab" href="#edit">Ajouter une facture</a>
                  </li>
                      ...
                      <div class="col-lg-8 col-lg-offset-2 detailed">
                        ...
                        <form role="form" class="form-horizontal"method="post" action="trtm/insctcmpt.php" >
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="number" placeholder=" " id="total" name="total" class="form-control">
                            </div>
                          </div>
                                     
						  <div class="form-group">
                            <label class="col-lg-2 control-label">date de facture</label>
                            <div class="col-lg-6">
                          ...
                          <div class="form-group">
                            <label class="col-lg-2 control-label">totale</label>
                            <div class="col-lg-6">
