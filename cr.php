...
{ ?>
                  <div id="edit" class="tab-pane">
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-lg-offset-2 detailed">
                        <h4 class="mb">Nouveau compte rendu</h4>
              ...
              <div class="form-group">
                            <label class="col-lg-2 control-label">coeur</label>
                            <div class="col-lg-6">
                              <input type="text" placeholder=" " id="coeur" name="coeur" class="form-control">
                            </div>
                          </div>
						  <div class="form-group">
